            ...
            <div class="card-body">
                <form method="POST" action="{{ route('menu.update', $menu->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="description" type="description" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ $menu->description }}" required autocomplete="description">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="keywords" type="text" class="form-control @error('keywords') is-invalid @enderror" name="keywords" value="{{ old('keywords', $menu->keywords) }}" required autocomplete="keywords">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="price" type="text" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ old('price', $menu->price) }}" autocomplete="new-price">
                            @error('price')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <select id="FoodCategory" class="form-control @error('FoodCategory') is-invalid @enderror" name="FoodCategory" required autocomplete="FoodCategory" autofocus>
                                ...
                                <option value="{{ $foodCategory }}" @if(old('FoodCategory', $menu->FoodCategory) == $foodCategory) selected @endif>{{ $foodCategory }}</option>
                                @endforeach
                            </select>
                            @error('FoodCategory')
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <select id="CourseCategory" class="form-control @error('CourseCategory') is-invalid @enderror" name="CourseCategory" required autocomplete="CourseCategory" autofocus>
                                ...
                                <option value="{{ $courseCategory }}" @if(old('CourseCategory', $menu->CourseCategory) == $courseCategory) selected @endif>{{ $courseCategory }}</option>
                                @endforeach
                            </select>
